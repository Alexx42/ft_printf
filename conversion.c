...
char	*conversion(const char *str, va_list args)
{
	...
	c = *str;
	if (c == 'd' || c == 'i')
		return (ft_itoa_b_pf_signed((va_arg(args, int)), 10, 0));
	else if (c == 'c' || c == 'C')
		...
		return (ft_itoa_b_pf(va_arg(args, unsigned int), 16, c == 'X'));
	else if (c == 'u' || c == 'D')
		return (ft_itoa_b_pf((va_arg(args, unsigned int)), 10, 0));
	else if (c == 'U')
...
char	*conversion_h(const char *str, va_list args)
{
	...
	c = *str;
	if (c == 'd' || c == 'i')
		return (ft_itoa_b_pf_signed((short int)(va_arg(args, int)), 10, 0));
	else if (c == 'c' || c == 'C')
		return (ft_chartostr((char)va_arg(args, int)));
	else if (c == 's')
		return (ft_strdup_pf(va_arg(args, char*)));
		...
		return (ft_itoa_b_pf((unsigned short int)va_arg(args, unsigned int),
			16, c == 'X'));
	else if (c == 'u' || c == 'D')
		return (ft_itoa_b_pf((unsigned short int)(va_arg(args, unsigned int)),
			10, 0));
...
char	*conversion_hh(const char *str, va_list args)
{
	...
	c = *str;
	if (c == 'd' || c == 'i')
		return (ft_itoa_b_pf_signed((signed char)(va_arg(args, int)), 10, 0));
	else if (c == 'c' || c == 'C')
		return (ft_chartostr((char)va_arg(args, int)));
	else if (c == 's')
		return (ft_strdup_pf(va_arg(args, char*)));
		...
		return (ft_itoa_b_pf((unsigned char)va_arg(args, unsigned int), 16,
			c == 'X'));
	else if (c == 'u' || c == 'D')
		return (ft_itoa_b_pf((unsigned char)(va_arg(args, unsigned int)),
			10, 0));
	else if (c == 'U')
		return (ft_itoa_b_pf((va_arg(args, unsigned long)), 10, 0));
	else if (c == 'p')
